defmodule WikiWeb.CharacterControllerTest do
  use WikiWeb.ConnCase

  alias Wiki.Topics

  @create_attrs %{age: "some age", content: "some content", name: "some name"}
  ...
  def fixture(:character) do
    {:ok, character} = Topics.create_character(@create_attrs)
    character
  end
